...
public class UpBooks extends javax.swing.JPanel {
    ...
    public UpBooks(String bid, String btitle, String bdate, String bauthor, String bcategory, String bedit, String blang, String bdesc, String bstock, String bavai){
        initComponents();
        conn = new Connect();
        reg = conn.getConnection();
        edition = true;
    ...
    private void initComponents() {
        ...
        add(Text12, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 100, -1, -1));
        ...
        add(descr, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 120, 260, 30));

        jSeparator13.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator13.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator13, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 260, 10));

        Text13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text13.setText("Stock");
        add(Text13, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 160, -1, -1));
        ...
        add(stock, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 80, 30));

        jSeparator14.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator14.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator14, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 210, 80, 10));
        ...
        add(available, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 250, 100, 30));

        jSeparator16.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator16.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator16, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, 100, 10));

        Text15.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text15.setText("Disponibles");
        add(Text15, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, -1, -1));
    ...
    private void dateMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dateMousePressed
       ...
       if(lang.getText().equals("") || lang.getText() == null || lang.getText().equals(" "))
        lang.setText("Ingrese el idioma del Libro");
       //(pages.getText().equals("") || pages.getText() == null || pages.getText().equals(" "))
       // pages.setText("Ingrese la cantidad de páginas totales");
       if(descr.getText().equals("") || descr.getText() == null || descr.getText().equals(" "))
        descr.setText("Ingrese la descripción del Libro");
       if(stock.getText().equals("") || stock.getText() == null || stock.getText().equals(" "))
    ...
    private void buttonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonMousePressed
        if(id.getText().equals("Ingrese el ID del Libro") || title.getText().equals("Ingrese el Título")
            ...
            || lang.getText().equals("Ingrese el idioma del Libro")
        ...
        else
        {
            ...
            if(bid == null || "".equals(bid) || btitle == null || "".equals(btitle) || bdate == null || "".equals(bdate) 
                    ...
                    || bedit == null || "".equals(bedit) || blang == null || "".equals(blang)
                ...
                try{
                    ...
                    try {
                        if(edition)
                            EditBook(bid, btitle, bdate, bathor, bcategory, bedit, blang, pag, bdescr, stc, av);
                        else
                            InsertBook(bid, btitle, bdate, bathor, bcategory, bedit, blang, pag, bdescr, stc, av);
    ...
    public void InsertBook(String id, String titu, String fech, String auth, String cate, String ed, String idiom, int pags, String desc, int stck, int avai) throws SQLException{
        Statement stm = reg.createStatement();
        
        stm.executeUpdate("INSERT INTO `books` (`id`, `title`, `date`, `author`, `category`, `edit`, `lang`, `pages`, `description`, `ejemplares`, `stock`, `available`) VALUES ('"+id+"', '"+titu+"', '"+ fech +"', '"+ auth +"', '"+cate+"', '"+ed+"', '"+idiom+"', '"+pags+"', '"+desc+"', '"+stck+"', '"+avai+"')");
        javax.swing.JOptionPane.showMessageDialog(this, "¡Libro registrado correctamente! \n", "HECHO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        
    }
    
    public void EditBook(String id, String titu, String fech, String auth, String cate, String ed, String idiom, int pags, String desc, int stck, int avai) throws SQLException{
        Statement stm = reg.createStatement();
        
        stm.executeUpdate("UPDATE `books` SET `id` = '"+id+"', `title` = '"+titu+"', `date` = '"+fech+"', `author` = '"+auth+"', `category` = '"+cate+"', `edit` = '"+ed+"', `lang` = '"+idiom+"', `pages` = '"+pags+"', `description` = '"+desc+"', `stock` = '"+stck+"', `available` = '"+avai+"' WHERE `id` = '"+ origId +"';");
